...
;(function(f作家y) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = f作家y(require('jquery'));
    } else {
        f作家y(jQuery);
    }
